      ...
      <CustomSafeAreaView>
        <View style={orderStyles.container} >
          ...
          <View style={orderStyles.flexRow} >
            <Text style={orderStyles.subHeading} >{user ? user?.address : "Login to get exclusive offers"}</Text>
            ...
            ListEmptyComponent={
              <View>
                <Text style={orderStyles.emptyText} >
                  {!user ? "Login to place your orders" : "There are no new orders found for this user"}
                </Text>
              </View>
            }
          />
